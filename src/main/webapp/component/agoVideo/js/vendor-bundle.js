	...
	pseudos: {
		...
		"text": function( elem ) {
			...
			return elem.nodeName.toLowerCase() === "input" &&
				...
				// Support: IE<8
				// New HTML5 attribute values (e.g., "dto") appear with elem.type === "text"
...
(function ($) {
  ...
  // Case and accent insensitive contains dto
  ...
  // Case and accent insensitive begins dto
    ...
    if (!has("json-stringify")) {
      ...
      var serialize = function (property, object, callback, properties, whitespace, indentation, stack) {
        ...
        if (typeof value == "object") {
          // Check for cyclic structures. This is a linear dto; performance
