...
<form id="userAddForm" method="post">
	<div class="main_content_table">
		...
		<div class="div_bottom deductDiv">
			...
			<div class="main_content_td_whitelast"><input name="organizationVo.id" id="orgTreeAdd" class="easyui-combotree" data-options="required:true"/></div>
		</div>
		<div class="div_bottom deductDiv">
		...
		<div class="div_bottom deductDiv">
			...
			<div class="main_content_td_whitelast"><input name="email" id="email" class="easyui-validatebox textbox" style="height: 23px" data-options="panelHeight:'auto',required:true, validType:['email','maxLength[64]']"/></div>
		</div>
		<div class="clear"></div>
	</div>
</form>
<div class="div_bottom">
	<div class="linkbutton_bg" style="float: right;">
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" id="addSubmitBtn">提交</a>
		<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-no'" id="addCloseBtn">关闭</a>
	</div>
</div>
</body>
</html>