    ...
    <div class="main_content_table">
        <div class="div_bottom">
            ...
            <div class="main_content_td_white_small"><input id="product_request" name="lendProductCode" class="easyui-combobox"
                                                            data-options="panelHeight:'200px',required:true"/>
            </div>
        </div>
        <div class="div_bottom">
        ...
        <div class="div_bottom">
            ...
            <div class="main_content_td_white_small"><input name="loanAmount" class="easyui-numberbox"
                                                            data-options="required:true,min:1,max:200000,prompt:'借款额度为 0—200000'"/>
            </div>
            <div class="main_content_td_graylast_small">电销中心推荐</div>
            <div class="main_content_td_whitelast_small"><input id="callCenter" name="callCenter" class="easyui-combobox"
                                                                data-options="panelHeight:'auto',url:'<%=basePath%>/dictionary/option/14',required:true,readonly:true"/>
            </div>
        </div>
        <div class="div_bottom">
