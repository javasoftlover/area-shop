...
<form id="houseForm" method="post">
    <div class="main_content_table">
        ...
        <div class="div_bottom" id="lendCustomer_repayMonthlyOfHousingLoans_Div" style="display: none;">
            ...
            <div class="main_content_td_whitelast_small"><input class="easyui-combobox" id="lendCustomer_lendHouseProve" name="lendCustomer.lendHouseProve" data-options="multiple:true,panelHeight:'auto',url:'<%=basePath%>/dictionary/option/25'"/></div>
        </div>
        <div class="clear"></div>
    </div>
</form>