...
<form id="professionForm" method="post">
    <div class="main_content_table">
        ...
        <div class="div_bottom" id="occupation_detail" style="display: none">
            <div style="width:10%" class="main_content_td_gray_small" id="lendCustomer_occupationInfo_salaryGetForm_first" style="display: none">工资发放形式</div>
            <div style="width:18%" class="main_content_td_white_small" id="lendCustomer_occupationInfo_salaryGetForm_second" style="display: none"><input id="lendCustomer_occupationInfo_salaryGetForm" name="lendCustomer.occupationInfo.salaryGetForm" class="easyui-combobox"
                                                                                                                                            data-options="panelHeight:'auto',url:'<%=basePath%>/dictionary/option/15',required:false"  style="width:200px;"/>
            </div>
            <div style="width:8%" class="main_content_td_graylast_small" id="lendCustomer_isProvideWageCard_first" style="display: none">提供工资卡流水</div>
            <div style="width:15%" class="main_content_td_whitelast_small" id="lendCustomer_isProvideWageCard_second" style="display: none"><input id="lendCustomer_isProvideWageCard" name="lendCustomer.isProvideWageCard" class="easyui-combobox"
            ...
            <div class="main_content_td_whitelast_small" style="width:14%" id="lendCustomer_occupationInfo_bankCard_second" style="display: none"><input id="lendCustomer_occupationInfo_bankCard" name="lendCustomer.occupationInfo.bankCard" class="easyui-validatebox textbox" style="height: 23px"
                                                            data-options="required:false, validType:['onlyNumberValidate']" /></div> 
            
            <div style="width:8%" class="main_content_td_graylast_small" id="lendCustomer_occupationInfo_lendTurnOverType_first" style="display: none">提供流水类型</div>
            <div style="width:16%" class="main_content_td_whitelast_small" id="lendCustomer_occupationInfo_lendTurnOverType_second" style="display: none"><input id="lendCustomer_occupationInfo_lendTurnOverType" name="lendCustomer.occupationInfo.lendTurnOverType" class="easyui-combobox"
                                                                                                                                               data-options="panelHeight:'auto',url:'<%=basePath%>/dictionary/option/35',required:false"/>
            </div>
            <div style="width:10%" class="main_content_td_graylast_small" id="lendCustomer_lendSoFundType_first" style="display: none">提供社保/公积金明细</div>
            <div style="width:14%" class="main_content_td_whitelast_small" id="lendCustomer_lendSoFundType_second" style="display: none"><input id="lendCustomer_lendSoFundType" name="lendCustomer.lendSoFundType" class="easyui-combobox"
