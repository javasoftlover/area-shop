...
Arith.calc = function (num1, num2, type){
	...
	this.roundNum = function(number, digit) {
	    var myOldAmt = "0";
	    if(isNaN(number)) {
	  	    return Arith.roundNum(myOldAmt, digit);
	    }
	    if(isNaN(digit)) {
	        return myOldAmt;
	    }
	...
	num1 = this.roundNum((typeof(num1) != "number"?Number(num1):num1), 10);
	num2 = this.roundNum((typeof(num2) != "number"?Number(num2):num2), 10);
