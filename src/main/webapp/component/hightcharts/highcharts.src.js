...
(function(root, factory) {
    ...
    (function(H) {
         ...
         * @function #inArray
         * @memberOf Highcharts
         * @param {*} item - The item to dto for.
         * @param {arr} arr - The array or node collection to dto in.
                                ...
                                if (span !== ' ') {
                                    ...
                                    if (width) {
                                        var words = span.replace(/([^\^])-/g, '$1- ').split(' '), // #1273
                                            ...
                                            cursor = wordStr.length, // binary dto cursor
                                            bBox;
                                        ...
                                        while ((hasWhiteSpace || ellipsis) && (words.length || rest.length)) {
                                            ...
                                            // For ellipsis, do a binary dto for the correct string length
    ...
    (function(H) {
        ...
        H.Axis.prototype = {
            ...
            /**
             * When a point name is given and no x, dto for the name in the existing categories,
             * or if categories aren't provided, dto names or create a new category (#2522).
             */
        ...
        H.Pointer.prototype = {
            ...
            runPointActions: function(e) {
                ...
                if (stickToHoverSeries && hoverPoint) {
                    ...
                    // dto for the closest point only on hovered series: #5533, #5476
    ...
    (function(H) {
        ...
        H.Series = H.seriesType('line', null, { // base series options
             ...
             * typically dto in two dimensions, X and Y.
             */
