...
<div class="easyui-layout" style="width:100%;height:100%;">
    ...
    <div id="formView">
        ...
        <div data-options="iconCls:'icon-view'" id="makeLoanFailReason">查看放款异常原因</div>
    </div>
        ...
        <form id="lendRequestManageForm" method="post" class="easyui-form">
            <div class="main_content_table">
                ...
                <div class="div_bottom">
                    ...
                    <div class="main_content_td_whitelast_small">
                        <div class="easyui-combobox" name="status" id="status" data-options="url:'../../dictionary/status/manage/LEND_PROCESSING',multiple:true,prompt:'状态',
    ...
    <div data-options="region:'center'">
        <table id="lendRequestManageTable" class="easyui-datagrid"
               data-options="idField:'lendRequestId',url:'../../lendRequestManage/lendRequestManages/list/LEND_PROCESSING',toolbar:'#lendRequestManagetoolbar',
               onSelect:function(){
                  ...
                  if($rows[0].lendRequestStatus.key==='CANCEL_SIGN'){
                        $('#viewCancelSign').show();
                          $('#rejectOrGiveUpReason').hide();
                           $('#makeLoanFailReason').hide();
                  }else if($rows[0].lendRequestStatus.key==='STORES_REFUSED_CREDIT'){
                        $('#rejectOrGiveUpReason').show();
                        $('#viewCancelSign').hide();
                             $('#makeLoanFailReason').hide();
                  }else if($rows[0].lendRequestStatus.key==='PROCESSING_ERROR'){
                        $('#makeLoanFailReason').show()
                  }else{
                         $('#rejectOrGiveUpReason').hide();
                            $('#viewCancelSign').hide();
                                 $('#makeLoanFailReason').hide();
