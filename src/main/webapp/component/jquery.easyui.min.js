...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:true,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:true,border:true,fit:true,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:true,singleSelect:true,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:true,pagePosition:"bottom",pageNumber:1,pageSize:20,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_64b(true),mouseout:_64b(false),click:_653,dblclick:_65d,contextmenu:_661},rowStyler:function(_7fd,_7fe){
...
var tr=_aa2.find("tr");
var clearableLen = opts.clearable?0:1;
for(var i=clearableLen;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
...
tr.find("td").css("width",(100/(opts.buttons.length-clearableLen))+"%");
};
function _a9a(_aa3){
...
return $.extend({},$.fn.combo.parseOptions(_aba),$.parser.parseOptions(_aba,["sharedCalendar",{clearable:"boolean"}]));
};
$.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{panelWidth:180,panelHeight:"auto",clearable:true,sharedCalendar:null,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
_aa6(this,q);
}},currentText:"Today",clearText:"Clear",closeText:"Close",okText:"Ok",buttons:[
{text:function(_abb){
return $(_abb).datebox("options").clearText;
...
return $(_ada).datetimebox("options").clearText;
